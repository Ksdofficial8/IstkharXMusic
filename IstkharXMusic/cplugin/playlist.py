...
from IstkharXMusic.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from IstkharXMusic import Carbon, app
from IstkharXMusic.utils.decorators.language import language, languageCB
from IstkharXMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
async def add_playlist_clone(client: Client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from IstkharXMusic import YouTube
