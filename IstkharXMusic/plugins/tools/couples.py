...
#BOT FILE NAME
from IstkharXMusic import app as app
from IstkharXMusic.mongo.couples_db import _get_image, get_couple
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "IstkharXMusic/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "IstkharXMusic/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("IstkharXMusic/assets/cppicbranded.jpg")
